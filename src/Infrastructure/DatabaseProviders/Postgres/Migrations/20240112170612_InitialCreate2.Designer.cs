...
namespace MediaServer.Infrastructure.DatabaseProviders.Postgres.Migrations
{
    ...
    [Migration("20240112170612_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseMediaIndexedFile", b =>
                {
                    b.Property<int>("BaseMediaId")
                        .HasColumnType("integer");

                    b.Property<int>("IndexedFilesId")
                        .HasColumnType("integer");

                    b.HasKey("BaseMediaId", "IndexedFilesId");

                    b.HasIndex("IndexedFilesId");

                    b.ToTable("BaseMediaIndexedFile");
                });
            ...
            modelBuilder.Entity("BaseMediaIndexedFile", b =>
                {
                    ...
                    b.HasOne("MediaServer.Domain.Entities.IndexedFile", null)
                        .WithMany()
                        .HasForeignKey("IndexedFilesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
