        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Track_SeasonId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseMedias_BaseMedias_SeasonId",
                        column: x => x.SeasonId,
                        principalTable: "BaseMedias",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseMedias_Libraries_MediaLibraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaFile_BaseMedias_BaseMediaId",
                        column: x => x.BaseMediaId,
                        principalTable: "BaseMedias",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MediaFile_Libraries_LibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseMedias_MediaLibraryId",
                table: "BaseMedias",
                column: "MediaLibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseMedias_SeasonId",
                table: "BaseMedias",
                column: "SeasonId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaFile_BaseMediaId",
                table: "MediaFile",
                column: "BaseMediaId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaFile_LibraryId",
                table: "MediaFile",
                column: "LibraryId");
        }
