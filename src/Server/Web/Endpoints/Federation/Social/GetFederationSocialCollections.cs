...
using K7.Server.Application.Features.Federation.Queries.GetFederationSocialCollections;
    ...
    public void Map(IEndpointRouteBuilder endpointRouteBuilder)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            var result = await sender.Send(
                new GetFederationSocialCollectionsQuery(clientId, viewerAssertion, originUserId),
                cancellationToken);
