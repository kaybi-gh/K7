...
using K7.Server.Application.Features.Federation.Queries.GetFederationSocialReviews;
    ...
    public void Map(IEndpointRouteBuilder endpointRouteBuilder)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            var result = await sender.Send(
                new GetFederationSocialReviewsQuery(clientId, viewerAssertion, originUserId),
                cancellationToken);
