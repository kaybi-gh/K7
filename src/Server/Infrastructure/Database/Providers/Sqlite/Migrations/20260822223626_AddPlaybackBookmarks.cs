...
public partial class AddPlaybackBookmarks : Migration
{
    private const string NewGuidSql =
        ...
        + "substr('AB89', abs(random()) % 4 + 1, 1) || substr(lower(hex(randomblob(2))),2) || '-' || lower(hex(randomblob(6)))";
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastCompletedEpisodeId = table.Column<Guid>(type: "TEXT", nullable: true),
                NextEpisodeId = table.Column<Guid>(type: "TEXT", nullable: true),
                ActivityAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                NextEpisodeAvailableAt = table.Column<DateTime>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.Sql($"""
            ...
            SELECT
                ...
                CASE
                    ...
                    ELSE 0
                END,
                NULL, NULL, NULL, NULL, '0001-01-01 00:00:00',
                Created, CreatedBy, LastModified, LastModifiedBy
            FROM UserMediaStates
            WHERE ExcludedFromContinueWatching = 0
              AND IsCompleted = 0
        ...
        migrationBuilder.Sql($"""
            ...
            FROM (
                ...
                WHERE ums.ExcludedFromContinueWatching = 0
                  AND ums.IsCompleted = 1
            ) completed
        ...
        migrationBuilder.Sql($"""
            ...
            FROM (
                ...
                INNER JOIN Medias season ON season.Id = episode.SeasonId AND season.Type = 6
                WHERE spms.ExcludedFromContinueWatching = 0
                  AND spms.IsCompleted = 1
            ) completed
            WHERE completed.RowNum = 1;
            """);
