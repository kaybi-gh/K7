...
namespace K7.Server.Infrastructure.Database.Providers.Postgres.Migrations
{
    ...
    [Migration("20250327165031_Transcoding2")]
    partial class Transcoding2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<string[]>("SupportedAudioCodecs")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<string[]>("SupportedContainers")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<string[]>("SupportedSubtitlesCodecs")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<string[]>("SupportedVideoCodecs")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Files.VideoFileMetadata", b =>
                {
                    ...
                    b.ToTable("FileMetadatas", t =>
                        {
                            t.Property("Container")
                                .HasColumnName("VideoFileMetadata_Container");
                        });
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Files.Tracks.VideoFileTrack", b =>
                {
                    ...
                    b.ToTable("FileTracks", t =>
                        {
                            t.Property("CodecName")
                                .HasColumnName("VideoFileTrack_CodecName");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.MovieMetadata", b =>
                {
                    b.HasBaseType("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.MusicAlbumMetadata", b =>
                {
                    b.HasBaseType("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.MusicTrackMetadata", b =>
                {
                    b.HasBaseType("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.SerieEpisodeMetadata", b =>
                {
                    b.HasBaseType("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.SerieMetadata", b =>
                {
                    b.HasBaseType("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.SerieSeasonMetadata", b =>
                {
                    b.HasBaseType("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata");
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.ExternalId", b =>
                {
                    b.HasOne("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata", "Metadata")
            ...
            modelBuilder.Entity("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata", b =>
                {
                    b.HasOne("K7.Server.Domain.Entities.Medias.BaseMedia", "Media")
                        .WithOne("Metadata")
                        .HasForeignKey("K7.Server.Domain.Entities.Metadatas.Medias.BaseMediaMetadata", "MediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
