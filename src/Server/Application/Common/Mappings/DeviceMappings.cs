...
public static class DeviceMappings
{
    extension(Device domain)
    {
        public DeviceDto ToDeviceDto() => new()
        {
            ...
            DisplayScreenHeight = domain.DisplayScreenHeight,
            DisplayScreenWidth = domain.DisplayScreenWidth,
            DisplayResolutionHeight = domain.DisplayResolutionHeight,
            DisplayResolutionWidth = domain.DisplayResolutionWidth,
