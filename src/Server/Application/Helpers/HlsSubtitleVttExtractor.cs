...
/// on ffmpeg: a blocked .vtt stalls ExoPlayer's A/V prefetch and causes freeze/desync.
/// </summary>
internal static class HlsSubtitleVttExtractor
{
        ...
        ILogger logger)
    {
        ...
        _ = ExtractAsync(mediaTranscoder, inputPath, trackIndex, vttCachePath, logger);
    }
