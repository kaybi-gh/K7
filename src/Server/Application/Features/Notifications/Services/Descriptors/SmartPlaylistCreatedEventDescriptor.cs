...
public class SmartPlaylistCreatedEventDescriptor : INotificationEventDescriptor
{
    public string EventTypeName => nameof(SmartPlaylistCreatedEvent);
    public string DisplayName => "Smart Playlist Created";
    public NotificationEventCategory Category => NotificationEventCategory.Playlist;
    public string DefaultTitleTemplate => "Smart Playlist Created";
    ...
    [
        ...
        new("SmartPlaylist.OrderDirection", "Order Direction", "String"),
    ];
}
