...
public class ChangePasswordCommandHandler(
    ...
    IUser currentUser,
    IIdentityService identityService) : IRequestHandler<ChangePasswordCommand>
{
    public async Task Handle(ChangePasswordCommand request, CancellationToken cancellationToken)
    {
        ...
        await identityService.ChangePasswordAsync(user.IdentityUserId, request.CurrentPassword, request.NewPassword);
    }
}
