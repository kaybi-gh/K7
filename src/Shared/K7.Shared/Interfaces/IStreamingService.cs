...
public interface IStreamingService
{
    ...
    Task ReportPlaybackProgressAsync(Guid mediaId, Guid sessionId, Guid referenceId, double position, double duration, int state, Guid? deviceId = null, Guid? playlistId = null, Guid? viewingGroupId = null, CancellationToken cancellationToken = default);
