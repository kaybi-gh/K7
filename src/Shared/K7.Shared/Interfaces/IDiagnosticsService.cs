...
public interface IDiagnosticsService
{
    ...
    Task<int> QueueDiagnosticFixesAsync(DiagnosticIssue issue, Guid? libraryId = null, CancellationToken cancellationToken = default);
}
