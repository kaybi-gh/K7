...
public interface IDiagnosticsService
{
    ...
    Task<PaginatedListDto<DiagnosticItemDto>> GetDiagnosticItemsAsync(Guid? libraryId = null, DiagnosticEntityType? entityType = null, DiagnosticIssue? issue = null, int pageNumber = 1, int pageSize = 20, CancellationToken cancellationToken = default);
