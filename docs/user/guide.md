...
4. On native apps, pin with **Show on this device**, then pick it on profile selection. Pinned shared profiles stay on that screen for every local user on the device, not only the members.
