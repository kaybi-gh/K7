...
Password rules follow the server policy (defaults: length at least 10, upper and lower case, a digit, at least 4 distinct characters). After setup, administrators can change these under Admin -> Authentication.
